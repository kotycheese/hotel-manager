...
public class ProcessingDialog extends javax.swing.JDialog {
     ...
     * Creates new form ProcessingDialog
     */
    public ProcessingDialog(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(bundle.getString("processing")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProcessingDialog dialog = new ProcessingDialog(new javax.swing.JFrame(), true);
